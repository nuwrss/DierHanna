...
public class MapMemorialsViewModel extends ViewModel {


    private  static  DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("Memorials");//Business
